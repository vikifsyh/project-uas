...
export default function AddProduct({ productToEdit, closeModal, isEditMode }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white p-6 rounded-lg max-w-3xl w-full">
        <h3 className="text-lg font-semibold mb-4">{isEditMode ? "Edit Product" : "Add New Product"}</h3>
        <form onSubmit={isEditMode ? handleUpdateData : handleCreateData}>
          ...
          <div className="flex justify-end">
            <button type="button" onClick={closeModal} className="bg-gray-300 text-gray-700 py-2 px-4 rounded mr-2">
              Close
            </button>
